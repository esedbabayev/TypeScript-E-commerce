...
const DetailsAndReviewsButtons: React.FC = () => {
  return (
    <div className="flex flex-col gap-3 w-1/6">
      <div className="cursor-pointer px-8 justify-start w-full py-4 rounded-lg bg-[#F6F6F6] flex items-center gap-3">
        <ThreeDots />
        <span className="font-medium text-[#0E1422]">Details</span>
      </div>
      <div className="cursor-pointer px-8 py-4 rounded-lg flex items-center gap-3">
        <Star />
